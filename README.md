...
- **Tournament** — a knock-out for the whole room. Everyone still in sings one song a round; when the last of them has sung, the lowest score of that round goes home, and the last one standing is the champion. Starting it turns scoring on and puts the crossfade aside — a performance should end, not melt into the next singer's — and stopping gives the crossfade back. Every screen shows the round and who still owes a song, and the moments themselves (the start, each knock-out, the champion) come up big for a few seconds on the shared screen and on everyone's own.
