...
| **Karaoke together** (`singalong`) | Watch together's layout, with the key under the player | The same: their own player, the lyrics, and the key. For singing along from different places. |
