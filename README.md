...
- **Tournament** — a knock-out for the whole room. Everyone still in sings one song a round; when the last of them has sung, the lowest score of that round goes home, and the last one standing is the champion. Starting it turns scoring on, every screen shows the round and who still owes a song, and the host can call it off at any point.
